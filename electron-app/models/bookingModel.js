...
function getAllBookings() {
    return new Promise((resolve, reject) => {
        db.query(`SELECT bookings.id, users.name, bookings.plate_num, CONCAT(parking_spaces.floor_num, " emelet, ", parking_spaces.parking_space_num, ". hely") AS parking_num, bookings.start_time, bookings.end_time, bookings.parking_status, bookings.payment_status, bookings.total_price, bookings.booked_at, parking_spaces.floor_num, parking_spaces.parking_space_num, bookings.parking_space_id
